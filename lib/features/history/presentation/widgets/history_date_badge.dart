...
class HistoryDateBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final month = shopDate(context, date, 'MMM').toUpperCase();
    // Some locales have no short month form. A month number is unambiguous;
    // never invent an abbreviation for a compound Hijri month name.
    final monthLabel = month.characters.length <= 4
        ? month
        : shopNumber(context, ShopCalendarScope.of(context).parts(date).month);
    return Tooltip(
